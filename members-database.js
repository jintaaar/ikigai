const profiles = [{
    ...
    games: [
        ...
        {name: "𝒃𝒖𝒅", icon: "apps/bud.jpg", id: "@𝒏𝒂𝒃𝒊_𝒊𝒌𝒊𝒈𝒂𝒊" },
        {name: "𝒉𝒆𝒂𝒓𝒕𝒐𝒑𝒊𝒂", icon: "apps/Heartopia.webp", id: "𝑼𝑰𝑫:𝟑𝒒𝟗𝟑𝟑𝒙𝒒𝒋" },
        {name: "𝒎𝒊𝒏𝒆𝒄𝒓𝒂𝒇𝒕", icon: "apps/minecraft.webp", id: "@𝒌𝒚𝒊𝒊𝒐𝒑𝒕𝒂" }
    ],
    connections: [
    ...
    games: [
        ...
        {name: "𝒃𝒖𝒅", icon: "apps/bud.jpg", id: "@𝒌𝒆𝒊𝒈𝒏_𝒊𝒌𝒊𝒈𝒂𝒊" },
        {name: "𝒎𝒊𝒏𝒆𝒄𝒓𝒂𝒇𝒕", icon: "apps/minecraft.webp", id: "@𝒌𝒆𝒊𝒈𝒏𝒏𝒙" }
    ],
    connections: [
    ...
    connections: [
        {name: "𝒅𝒊𝒔𝒄𝒐𝒓𝒅", icon: "apps/discord.jpg", id: "@𝒎𝒔𝒈_𝒆𝒅𝒃" },
        {name: "𝒕𝒊𝒌𝒕𝒐𝒌", icon: "apps/tiktok.avif", id: "@𝒊𝒌𝒊𝒈𝒂𝒊_𝒓𝒆𝒂𝒉𝒏" }
    ]
},{
    dataid: '4',
    ...
    games: [
        ...
        {name: "𝒉𝒆𝒂𝒓𝒕𝒐𝒑𝒊𝒂", icon: "apps/Heartopia.webp", id: "𝑼𝑰𝑫:𝟑𝟔𝟑𝟏𝟓𝒒𝟗𝒑" }
    ],
    connections: [
        {name: "𝒅𝒊𝒔𝒄𝒐𝒓𝒅", icon: "apps/discord.jpg", id: "@𝒔𝒑𝒆𝒆𝒅𝒚𝒕𝒊𝒎𝒆𝟐𝟒" },
        {name: "𝒕𝒊𝒌𝒕𝒐𝒌", icon: "apps/tiktok.avif", id: "@𝒔𝒑𝒆𝒆𝒅𝒚𝒕𝒊𝒎𝒆𝒐𝒇𝒇𝒊𝒄𝒊𝒂𝒍" }
    ]
},{
    dataid: '5',
    ...
    connections: [
        {name: "𝒅𝒊𝒔𝒄𝒐𝒓𝒅", icon: "apps/discord.jpg", id: "@𝒎𝒆𝒂𝒏𝒏𝒆𝟕𝟗𝟓𝟒" },
        {name: "𝒕𝒊𝒌𝒕𝒐𝒌", icon: "apps/tiktok.avif", id: "@𝒊𝒌𝒈_𝒃𝒆𝒂𝒖" }
    ]
},{
    dataid: '6',
    ...
    games: [
        ...
        {name: "𝒃𝒖𝒅", icon: "apps/bud.jpg", id: "@𝒍𝒊𝒍𝒊𝒕𝒉_𝒊𝒌𝒊𝒈𝒂𝒊" },
        {name: "𝒉𝒆𝒂𝒓𝒕𝒐𝒑𝒊𝒂", icon: "apps/Heartopia.webp", id: "𝑼𝑰𝑫:𝟏𝒚𝒒𝟔𝟓𝒒𝟒𝟗" },
        {name: "𝒎𝒊𝒏𝒆𝒄𝒓𝒂𝒇𝒕", icon: "apps/minecraft.webp", id: "@𝒊𝒌𝒈_𝒍𝒊𝒍𝒊𝒕𝒉" }
    ],
    connections: [
        {name: "𝒅𝒊𝒔𝒄𝒐𝒓𝒅", icon: "apps/discord.jpg", id: "@𝒍𝒊𝒍𝒊𝒊𝒕𝒉_𝟑𝟎" },
        {name: "𝒕𝒊𝒌𝒕𝒐𝒌", icon: "apps/tiktok.avif", id: "@𝒊𝒌𝒈_𝒍𝒊𝒍𝒊𝒕𝒉" }
    ]
},{
    dataid: '7',
    image: 'profiles/dongdong2.png',
    ...
    games: [
        ...
        {name: "𝒎𝒊𝒏𝒆𝒄𝒓𝒂𝒇𝒕", icon: "apps/minecraft.webp", id: "@𝒍𝒖𝒄𝒊𝒐𝒕𝒂𝒏𝟐𝟎𝒕𝒉" }
    ],
    connections: [
        {name: "𝒅𝒊𝒔𝒄𝒐𝒓𝒅", icon: "apps/discord.jpg", id: "@𝒊𝒌𝒈_𝒍𝒖𝒄𝒊𝒐𝒕𝒂𝒏" },
    ...
    games: [
        ...
        {name: "𝒃𝒖𝒅", icon: "apps/bud.jpg", id: "@𝒋𝒊𝒏𝒕𝒂𝒓_𝒊𝒌𝒊𝒈𝒂𝒊" },
        {name: "𝒉𝒆𝒂𝒓𝒕𝒐𝒑𝒊𝒂", icon: "apps/Heartopia.webp", id: "𝑼𝑰𝑫:𝟏𝒋𝒋𝒘𝟑𝒏𝒇𝒔" },
        {name: "𝒎𝒊𝒏𝒆𝒄𝒓𝒂𝒇𝒕", icon: "apps/minecraft.webp", id: "@𝒋𝒊𝒏𝒕𝒂𝒂𝒂𝒓" },
        {name: "𝒂𝒖𝒅𝒊𝒕𝒊𝒐𝒏", icon: "apps/audi.jpg", id: "@𝒊𝒌𝒈_𝒋𝒊𝒏𝒕𝒂𝒓" }
    ],
    connections: [
        {name: "𝒅𝒊𝒔𝒄𝒐𝒓𝒅", icon: "apps/discord.jpg", id: "@𝒋𝒊𝒏𝒕𝒂𝒂𝒂𝒓" },
    ...
    connections: [
        {name: "𝒅𝒊𝒔𝒄𝒐𝒓𝒅", icon: "apps/discord.jpg", id: "@𝒉𝒂𝒕𝒆𝒓𝒅𝒊𝒏𝒃𝒂𝒌𝒊𝒕𝒂" },
    ...
    games: [
        {name: "𝒆𝒈𝒈𝒚 𝒑𝒂𝒓𝒕𝒚", icon: "apps/eggyparty.png", id: "@𝒊𝒌𝒈_鲁恩" },
        {name: "𝒓𝒐𝒃𝒍𝒐𝒙", icon: "apps/roblox.webp", id: "@𝑫𝒖𝒄𝒌𝒚𝟎𝟐𝟓𝟎" },
    ],
    connections: [
        {name: "𝒅𝒊𝒔𝒄𝒐𝒓𝒅", icon: "apps/discord.jpg", id: "@𝒓𝒖𝒏𝒏_." },
